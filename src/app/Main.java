...
import app.executar.ExecutarEmpresa;
import app.executar.ExecutarAdm;
import app.executar.ExecutarCliente;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Produto produto11 = new Produto(7, "Suco Natural", 30, 10.0, empresa);
		...
		List<Produto> produtos = Arrays.asList(produto, produto2, produto3, produto4, produto5, produto6, produto7,
				produto11, produto8, produto9, produto10);
		while (true) {
